...
expr: a=desc ';' b=loc_equip ';' c=loc_equip ';' d=data NEWLINE # descLocEquipData //aceita a frase com todos os campos
    | b=loc_equip ';' c=loc_equip ';' d=data NEWLINE # locEquipData
    ...
    //| a=desc ';' c=loc_equip ';' d=data NEWLINE { System.out.println("Dados incompletos. Tente novamente.");} // não aceita com descrição, equipmento e data
